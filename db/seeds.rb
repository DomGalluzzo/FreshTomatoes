...
# ! Reviews
# Seed 1
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed1, movie: space_odyssey)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed1, movie: godfather1)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed1, movie: raiders_lost_ark)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed1, movie: will_be_blood)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed1, movie: dark_knight)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed1, movie: airplane)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed1, movie: alien)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed1, movie: her)

# Seed 2
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed2, movie: space_odyssey)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed2, movie: godfather1)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed2, movie: raiders_lost_ark)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed2, movie: will_be_blood)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed2, movie: dark_knight)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed2, movie: airplane)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed2, movie: alien)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed2, movie: her)

# Seed 3
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed3, movie: space_odyssey)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed3, movie: godfather1)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed3, movie: raiders_lost_ark)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed3, movie: will_be_blood)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed3, movie: dark_knight)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed3, movie: airplane)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed3, movie: alien)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed3, movie: her)

# Seed 4
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed4, movie: space_odyssey)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed4, movie: godfather1)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed4, movie: raiders_lost_ark)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed4, movie: will_be_blood)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed4, movie: dark_knight)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed4, movie: airplane)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed4, movie: alien)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed4, movie: her)

# Seed 5
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed5, movie: space_odyssey)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed5, movie: godfather1)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed5, movie: raiders_lost_ark)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed5, movie: will_be_blood)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed5, movie: dark_knight)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed5, movie: airplane)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed5, movie: alien)
Review.create!(comment: Faker::Movie.quote, rating: Faker::Number.within(range: 1..10), user: seed5, movie: her)
